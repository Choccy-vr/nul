...
I am going to ask in Slack, but yeah, admire the work.image
...
Unfortunately, I had to omit the test points, but tbh I was probably not going to use them.image
...
Everything fit with just enough space, and I think we are good.image
...
removed L2
verified things And yeah, so lots of stuff done; it took me a while, but now the schematic should be fully done and ready to start laying out the PCB.image
Footprints
Jul 30, 2026
Ginobeano
Ginobeano
...
But at last it is done and we got the worst part out of the way. Worst part is I had to do this all 2 times because I accidentally cleared all the entries my first time.image
...
imageNext are my least favorite steps of all time. LCSC part numbers and footprints
...
It took me a while just reading all the docs for the level shifter and getting it all right. I did abunch of other stuff look in the repo I am tired and I am going to go to bed. gn.imageimage
...
Moved to Macondo
This project originated in Forge, but since I revived it quite a bit later and am already familiar with Macondo, I figured I'd just keep it here. So I moved all the journals over here.image
...
imageand for the level shifter I found the SN74AHCT1G125DBVR and one other one that I decided againstimageNow the level shifter is extended, so depending on it, I might just hand-solder this.
...
UART
LED Data light
and a few more things This time was mostly back and forth, getting feedback, reading documentation, and all that, but isn't that what building hardware is?image.png
...
Schematic
I started work on the schematic, yay! Right now, it is very bare bones and just setting up the ESP. I got the SiP and all the decoupling capacitors, crystal, etc. I still have to get the antenna to complete this part of the schematic, but that isn't important. I still need to set up literally everything else, but so far it is going well.image.png(Sorry for not devlogging for like 2 weeks, I lost interest)
...
and more
Photo from 2026-05-08 20-01-09.947676.jpeg
...
I already have a chip antenna idk what model it is. I will find out tmrw.Screenshot From 2026-05-08 20-03-37.pngScreenshot From 2026-05-08 20-04-37.png
